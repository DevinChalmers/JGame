...
public class TurnHandler
{
    ...
    public void renderTurnButton(Graphics2D g2)
    {
        ...
        TextRenderer.renderText(g2, String.valueOf(LH.currentLevel.CH.energy), ArtLoader.perfectFont, Color.white, (int)buttonX + (int)buttonW/2, (int)buttonY +  buttonH + 30);
    }
